...
class Complaint(models.Model):
    ...
    ('Chemical', "Chemical"), ('Civil', "Civil"), ('Computer Science', "Computer Science"),
    ('Electrical',"Electrical"), ('Electronics', "Electronics"), ('Mechanical', "Mechanical"),
    ...
    drive_link = models.URLField(max_length=400, blank=True)
    ...
    def __str__(self):
        return self.name + '[' + self.type_of_complaint + ']'
